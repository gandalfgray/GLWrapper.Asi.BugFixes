...
struct H3Main
{
 ...
 INT8 unk1[4];
 INT8 campaignInfo[124]; // * +1F458
 INT8 unk2[354];
 BOOLEAN isDead[8]; // * +1F636
 WORD curr_day; // * +1F63E
 ...
 INT8 grail[8]; // * +1F690
 INT32 mapKind; // * +1F698 (0 - RoE, 1 - AB, 2 - SoD)
 BOOLEAN isCheater; // * +1F69C
 BOOLEAN inTutorial; // * +1F69D (fun fact : Griffin dwelling doesn't require Blacksmith in this mode)
 INT8 unk4[2];
