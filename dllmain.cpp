...
int RandMap_PreSelectedHeroes[8];

bool gChat;
int send2ChatProcAddr;
int __stdcall send2Chat(LoHook* h, HookContext* c) 
{
	...
	{
		gChat = false;
		CALL_2(char, __fastcall, send2ChatProcAddr, mes, 127);
	}
...
BOOL APIENTRY DllMain( HMODULE hModule, DWORD  ul_reason_for_call, LPVOID lpReserved )
{
    if ( DLL_PROCESS_ATTACH == ul_reason_for_call)
    {
        if (!plugin_On)
        {
            plugin_On = 1;       
            _P = GetPatcher();
			_PI = _P->CreateInstance("Z10_BugFixes_A");
            ...
            {  
				...
				send2ChatProcAddr = 0x554BB0;
				getItemProcAddress = 0x5FF5B0;
            ...
            if(check1 == (WS_VISIBLE | WS_POPUP) && check2 == (WS_VISIBLE | WS_POPUP))
            {
				...
				send2ChatProcAddr = 0x54CDC0;
				getItemProcAddress = 0x5F6750;
				...
				// Подготавливаем информацию о стартовых героях игроков.
				//_PI->WriteLoHook(0x57DAB4, LoHook_RandMapGen_Prepare_StartHeroesInfo);
            ...
            if(check1 == (WS_VISIBLE | WS_POPUP) && check2 == (WS_VISIBLE | WS_POPUP))
            {
				...
				send2ChatProcAddr = 0x54D700;
				getItemProcAddress = 0x5F6710;
				...
				// Подготавливаем информацию о стартовых героях игроков.
				//_PI->WriteLoHook(0x57E034, LoHook_RandMapGen_Prepare_StartHeroesInfo);
            ...
            {	    
				...
				send2ChatProcAddr = 0x554CA0;
				getItemProcAddress = 0x5FF7E0;
				...
				// Подготавливаем информацию о стартовых героях игроков.
				//_PI->WriteLoHook(0x5862B4, LoHook_RandMapGen_Prepare_StartHeroesInfo);
            ...
            {  
				...
				send2ChatProcAddr = 0x5547A0;
				getItemProcAddress = 0x5FF610;
				...
				// Подготавливаем информацию о стартовых героях игроков.
				//_PI->WriteLoHook(0x586564, LoHook_RandMapGen_Prepare_StartHeroesInfo);
            ...
            {	    
				...
				send2ChatProcAddr = 0x535220;
				getItemProcAddress = 0x5D63C0;
            ...
            {		    
				...
				send2ChatProcAddr = 0x552020;
				getItemProcAddress = 0x5FD060;
				...
				// Подготавливаем информацию о стартовых героях игроков.
				//_PI->WriteLoHook(0x584314, LoHook_RandMapGen_Prepare_StartHeroesInfo);
            ...
            {    
				...
				send2ChatProcAddr = 0x5547C0;
				getItemProcAddress = 0x5FEFF0;
				...
				// Подготавливаем информацию о стартовых героях игроков.
				//_PI->WriteLoHook(0x586364, LoHook_RandMapGen_Prepare_StartHeroesInfo);
            ...
            if(check1 == (WS_VISIBLE | WS_POPUP) && check2 == (WS_VISIBLE | WS_POPUP))
            {
				...
				send2ChatProcAddr = 0x552960;
				getItemProcAddress = 0x5FD840;
				...
				// Подготавливаем информацию о стартовых героях игроков.
				//_PI->WriteLoHook(0x5845A4, LoHook_RandMapGen_Prepare_StartHeroesInfo);
            ...
            if(check1 == (WS_VISIBLE | WS_POPUP) && check2 == (WS_VISIBLE | WS_POPUP))
            {
				...
				send2ChatProcAddr = 0x554F60;
				getItemProcAddress = 0x5FFD50;
				...
				// Подготавливаем информацию о стартовых героях игроков.
				//_PI->WriteLoHook(0x586B14, LoHook_RandMapGen_Prepare_StartHeroesInfo);
            ...
            if(check1 == (WS_VISIBLE | WS_POPUP) && check2 == (WS_VISIBLE | WS_POPUP))
            {
				...
				send2ChatProcAddr = 0x554040;
				getItemProcAddress = 0x5FF5F0;
				...
				// Подготавливаем информацию о стартовых героях игроков.
				//_PI->WriteLoHook(0x5860A4, LoHook_RandMapGen_Prepare_StartHeroesInfo);
            ...
            if(check1 == (WS_VISIBLE | WS_POPUP) && check2 == (WS_VISIBLE | WS_POPUP))
            {
				...
				send2ChatProcAddr = 0x551A10;
				getItemProcAddress = 0x5FCE00;
				...
				// Подготавливаем информацию о стартовых героях игроков.
				//_PI->WriteLoHook(0x583B54, LoHook_RandMapGen_Prepare_StartHeroesInfo);
